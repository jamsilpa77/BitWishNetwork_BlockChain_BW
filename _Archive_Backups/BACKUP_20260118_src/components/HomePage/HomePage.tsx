...
const HomePage: React.FC = () => {
     ...
     * TODO: 백엔드에 /api/statistics/mining 엔드포인트 구현 필요
     */
    const fetchGlobalStats = async () => {
        try {
            // 임시로 비활성화 - 백엔드 엔드포인트 미구현
            // const response = await fetch('/api/statistics/mining');
    ...
    return (
        <div className={`home-page ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
                ...
                <section className="blockchain-status-section">
                    <div className="status-header">
                        ...
                        <p className="status-description">
                            {getTranslation('mining.description')}
                        </p>
                    ...
                    <div className="status-cards-grid">
                        ...
                        <div className="status-card-row">
                            ...
                            <div className="status-card">
                                ...
                                <div className="card-content">
                                    {(() => {
                                        const { integerPart, decimalPart } = splitNumber(globalStats.remainingSupply);
                                        return (
                                            <div className="card-value multi-line">
                                                <div className="value-integer">{integerPart}</div>
                                                <div className="value-decimal">{decimalPart} BW</div>
                        ...
                        <div className="status-card-row">
                            ...
                            <div className="status-card">
                                ...
                                <div className="card-content">
                                    <div className="card-value">{globalStats.totalBlocks.toLocaleString()}</div>
                            ...
                            <div className="status-card">
                                ...
                                <div className="card-content">
                                    <div className="card-value">{globalStats.totalUsers.toLocaleString()}</div>
            ...
            <footer className="home-footer">
                <div className="footer-content">
                    <p className="footer-text">
                        © 2024 BitWishNetwork. All rights reserved.
                    </p>
                    <div className="footer-links">
                        ...
                        <a href="/terms" className="footer-link">
                            {getTranslation('navigation.terms')}
                        </a>
                    </div>
                </div>
            </footer>
            ...
            {isCreateWalletModalOpen && (
                <CreateWalletModal
                    ...
                    onComplete={(newAddress) => {
                        console.log('HomePage: onComplete called, switching modals', newAddress);
            ...
            <MyWalletModal
                ...
                currentLanguage={currentLanguage}
                onOpenMining={() => {
                    // [관리자 지시사항] 지갑 주인의 프리패스 권한: 비밀번호 입력 없이 즉시 마이닝 페이지 오픈
