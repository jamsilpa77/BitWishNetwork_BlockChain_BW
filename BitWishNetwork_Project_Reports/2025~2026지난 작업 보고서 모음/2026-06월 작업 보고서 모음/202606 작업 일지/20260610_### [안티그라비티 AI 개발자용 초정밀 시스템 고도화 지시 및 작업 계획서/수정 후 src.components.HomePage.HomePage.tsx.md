                        ...
                        <div>
                            <strong style={{ color: isExtensionInstalled ? '#166534' : '#854d0e', fontSize: '15px', display: 'block' }}>
                                {isExtensionInstalled 
                                    ? 'Chrome Extension Active! (Max +15% Boost Connected)' 
                                    : 'Chrome Extension Promotion Bonus (Attendance 5% + Mnemonic 10% = Max 15% Boost)'}
                            </strong>
                            <span style={{ color: isExtensionInstalled ? '#15803d' : '#a16207', fontSize: '13px' }}>
                                {isExtensionInstalled 
                                    ? '확장프로그램 연결이 감지되었습니다. 출석(5%) & 니모닉(10%) 부스트가 활성화됩니다.'
                                    : 'Chrome 확장프로그램을 설치하고 출석 보너스(5%)와 안전 니모닉 인증(10%) 채굴률 부스트를 받으세요!'}
                            </span>
                        </div>
                    </div>
                    {!isExtensionInstalled ? (
