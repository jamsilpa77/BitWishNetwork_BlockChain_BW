  ...
  private initializeLanguageData(): void {
    ...
    this.languageData.set('ko', {
      ...
      explorer: {
        ...
        loading: '데이터 로딩 중...',
        unknown: '알 수 없음',
        totalCirculating: 'BW코인 총 발행량',
        foundationAllocation: '재단/운영팀 할당량',
        ecosystemAllocation: '생태계 할당 수량 (80%)',
        minerAllocation: '개인채굴자 할당량 (65%)',
        partnerAllocation: '파트너/가맹/사업자 할당량 (15%)',
        createdWallets: '지갑 생성 수',
        ecosystemFundTitle: '네트워크 생태계 누적 기금',
        txFees: '거래 수수료',
        blockFees: '블록 생성 수수료',
        totalFees: '총 누적 기금 합계',
        latestOperations: '실시간 네트워크 활동 (Operations)',
        viewAll: '전체 보기',
        opAdminFundTx: '🛡️ 어드민 다중서명을 통해 펀드 송금이 완료됨',
        opKycBotTx: '👤 무인 봇이 새로운 KYC 유저에게 코인을 입금함',
        opBurnEvent: '🔥 네트워크 생태계 방어를 위한 수수료 자동 소각',
        latestTransactions: '뱅킹 이체 내역 (Transactions)',
        txFrom: '출금',
        txTo: '입금',
        txAmount: '전송 금액',
        txFee: '수수료',
    ...
    this.languageData.set('en', {
      ...
      explorer: {
        ...
        unknown: 'Unknown',
        totalCirculating: 'Total BW Supply',
        foundationAllocation: 'Foundation Allocation',
        ecosystemAllocation: 'Ecosystem Allocation (80%)',
        minerAllocation: 'Miner Allocation (65%)',
        partnerAllocation: 'Partner Allocation (15%)',
        createdWallets: 'Wallets Created',
        ecosystemFundTitle: 'Network Ecosystem Fund',
        txFees: 'Tx Fees',
        blockFees: 'Block Fees',
        totalFees: 'Total Combined Fund',
        latestOperations: 'Real-time Network Operations',
        viewAll: 'View All',
        opAdminFundTx: '🛡️ Fund transfer completed via Admin Multi-sig',
        opKycBotTx: '👤 Automated bot deposited coins to new KYC user',
        opBurnEvent: '🔥 Fee burned to maintain network ecosystem',
        latestTransactions: 'Banking Transactions',
        txFrom: 'From',
        txTo: 'To',
        txAmount: 'Amount',
        txFee: 'Fee',
    ...
    this.languageData.set('ja', {
      ...
      explorer: {
        ...
        blockFees: 'ブロック生成手数料',
        totalFees: '累積基金合計',
        latestOperations: 'リアルタイムネットワーク活動 (Operations)',
        viewAll: 'すべて見る',
        opAdminFundTx: '🛡️ 管理者のマルチシグによりファンド送金が完了',
        opKycBotTx: '👤 無人ボットが新規KYCユーザーにコインを入金',
        opBurnEvent: '🔥 ネットワークエコシステム維持のための手数料自動焼却',
        latestTransactions: 'バンキング送金履歴',
        txFrom: '出金',
        txTo: '入金',
        txAmount: '送金額',
        txFee: '手数料',
    ...
    this.languageData.set('zh', {
      ...
      explorer: {
        ...
        loading: '数据加载中...',
        unknown: '未知',
        totalCirculating: 'BW币总发行量',
        foundationAllocation: '基金会/运营团队配额',
        ecosystemAllocation: '生态系统配额 (80%)',
        minerAllocation: '个人矿工配额 (65%)',
        partnerAllocation: '合作伙伴/加盟/商家配额 (15%)',
        createdWallets: '钱包创建数',
        ecosystemFundTitle: '网络生态系统累计基金',
        txFees: '交易手续费',
        blockFees: '区块生成手续费',
        totalFees: '累计基金总计',
        latestOperations: '实时网络活动 (Operations)',
        viewAll: '查看全部',
        opAdminFundTx: '🛡️ 管理员多重签名完成基金转账',
        opKycBotTx: '👤 无人机器向新 KYC 用户存入代币',
        opBurnEvent: '🔥 自动销毁手续费以维护网络生态系统',
        latestTransactions: '银行转账记录',
        txFrom: '转出',
        txTo: '转入',
        txAmount: '转账金额',
        txFee: '手续费',
