...
class AdminSecureAPI {
     ...
     */
    async registerHardwareKey(req, res) {
    ...
    async executepayout(req, res) {
        ...
        const result = await this.blockchain.adminSupremeWithdraw(targetAddress, amount, source, hardwareSignature);
        if (result.success) {
...
exports.AdminSecureAPI = AdminSecureAPI;
//# sourceMappingURL=admin-secure-api.js.map